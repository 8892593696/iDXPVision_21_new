...
<div id='columnMappingTree' class='columnMappingTree'></div>");
    $("#columnMappingDialog").dialog({ resizable: false,
                ...
                success: function (data, status, xhr) {
                    ...
                    if (data != null && data != '') {
                        ...
                        if (response['messageFlag']) {
                            ...
                            $("#columnMappingFormDialog").dialog({ resizable: false,
    ...
    if (getLinksTo != null && getLinksTo.length != 0) {
        ...
        $.ajax({
            ...
            success: function (response, status, xhr) {
                ...
                $("#columnSQLMappingDialog").dialog({ resizable: false,
...
function openLogFile() {
    ...
    $("#dialogLogFile").dialog({ resizable: false,
...
function dataTypeDialog($this) {
    ...
    if (allDataTypeObjStr != null && allDataTypeObjStr != '') {
        ...
        if (allDataTypeObj != null && !jQuery.isEmptyObject(allDataTypeObj)) {
            ...
            $("#dataTypeDialog").dialog({ resizable: false,
        ...
        success: function (response) {
            ...
            if (response != null) {
                ...
                if (selectedItemIndex == null) {
                    ...
                    divStr += "<img src='images/iDXPUI5Refresh.svg' style='width:18px;height: 18px;cursor:pointer;padding-left:3px;margin-right:5px;' onclick=refreshTableGrid('" + gridId + "') title='Refresh'>"
                    ...
                    $("#dataViewDiv").append(divStr);
//                    $("#dataViewDiv").append("<div><div><img src='images/iDXPUI5Refresh.svg' style='width:18px;height: 18px;cursor:pointer;padding-left:3px;' onclick=refreshTableGrid('" + gridId + "') title='Refresh'></div><div id='" + gridId + "'></div>"); // ravi edit for tabs navigation
                    $('#dataViewDiv').jqxTabs({width: "100%", height: "100%", position: 'top', theme: 'ui-redmond', reorder: true});
...
//                    $('#dataViewDiv').jqxTabs('addLast', DBValue + "." + tableName, '<div><div><img src="images/iDXPUI5Refresh.svg" style="width:18px;height: 18px;cursor:pointer;padding-left:3px;" onclick=refreshTableGrid("' + gridId + '") title="Refresh"></div><div id="' + gridId + '"></div></div>'); // ravi edit for tabs navigation
                }
...
function finalImport(gridId) {
    ...
    $("#dataMigratorPopup").dialog({ resizable: false,
