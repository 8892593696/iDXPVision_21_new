...
function gridDeTreeBoxes(urlService, jsonData) {
    var urlService_ = '';
    var treeInitialized = jsonData['init'];
    var minHeight = jsonData['minHeight'];
    if (minHeight == undefined) {
...
//    var depthSelector = parseInt($("#depthSelector").val());
    ...
    var rectNode = {width: 120, height: 50, textMargin: 5},
            tooltip = {width: 160, height: 50, textMargin: 5};
    var i = 0,
            duration = 750,
            root;
    ...
    function update(source) {
        ...
        var nodeEnter = node.enter().insert('g', 'g.node')
                ...
                .style('stroke', function (d) {
                    var strokeColor = d["strokeColor"];
                    if (strokeColor != null && strokeColor != undefined && strokeColor != '')
                        return strokeColor;
                    if (d["depth"] == 0)
                        return $("#deComTreeNodeColor0").val();
                    if (d["depth"] == 1)
                        return $("#deComTreeNodeColor1").val();
                    if (d["depth"] == 2)
                        return $("#deComTreeNodeColor2").val();
                    if (d["depth"] == 3)
                        return $("#deComTreeNodeColor3").val();
                    if (d["depth"] == 4)
                        return $("#deComTreeNodeColor4").val();
                    if (d["depth"] > 4)
                        var returnId = "";
                    ...
                    try {
                        ...
                        var levelNo = "" + d["depth"] + "";
                        var childId = document.getElementById("colorAdderlevelP" + levelNo);
                        if (childId != null && childId != undefined && childId != '') {
                        } else {
                            var colordiv = '<div class="innerColorSelect"><span class="colorLevelLabel" value="' + levelNo + '" colorHex="#0b4a99">Level ' + levelNo + '</span><span class="colorLevelSelect"><input type="color" class="colorAdderPopup" id="colorAdderlevelP' + levelNo + '" level ="' + levelNo + '" value="#0b4a99"></span></div>';
                            $('.colorselectDiv').append(colordiv);
////                        console.log(colordiv);
                            $(".colorAdderPopup").on('input', function (event) {
                                var color = $(this).val();
                                $(this).val(color);
                                var depthLevel = $(this).attr("level");
                                changeTreeColorPoppup(color, depthLevel, d);
//                                changeLinkColour(node, color); 
                            });
                        }
                    } catch (r) {
                        console.log(r);
                    ...
                    try {
                        var childId = document.getElementById("deComTreeNodeColor" + d["depth"]);
                        var parent = childId ? childId.parentNode : {};
                        returnId = parent.id && parent.id === "deComMainDiv" ? childId : null;
                    } catch (t) {
                        returnId = "";
                    }

                    if (returnId != null && returnId != undefined && returnId != '') {
                        return $("#deComTreeNodeColor" + d["depth"]).val();
                    } else {
                        var div = document.getElementById("deComMainDiv");
                        var input = document.createElement("input");
                        input.type = "hidden";
                        input.id = "deComTreeNodeColor" + d["depth"];
                        input.level = d["depth"];
                        input.value = "#0b4a99";
...
//                    var myNodeName = d['nodeName'];
//                    if (d["depth"] == 0 && myNodeName != null && myNodeName != undefined && myNodeName != '') {
//                        return "#00acee";
//                    }
//                    if (myNodeName === 'TWITTER') {
//                        return '#00acee';
//                    } else if (myNodeName == 'YOUTUBE') {
//                        return '#FF0000';
//                    } else if (myNodeName == 'NEWS PAPER') {
//                        return '#4169E1';
//                    } else if (myNodeName == 'News Channel') {
//                        return '#0047AB';
//                    } else if (myNodeName == 'JSP') {
//                        return '#FF0000';
//                    } else if (myNodeName == 'PUBLIC') {
//                        return '#f3cea1'
//                    } else if (myNodeName == 'null') {
//                        return '#FF0000';
//                    } else if (myNodeName == 'YSRCP') {
//                        return '#0266b4';
//                    } else if (myNodeName == 'AIMIM') {
//                        return '#20783B'
//                    } else if (myNodeName == 'BJP') {
//                        return '#F97D09'
//                    } else if (myNodeName == 'INC') {
//                        return '#009900';
//                    } else if (myNodeName == 'IND') {
//                        return '#dc3066';
//                    } else if (myNodeName == 'JSP') {
//                        return '#da2824';
//                    } else if (myNodeName == 'PILOG') {
//                        return '#1DA1F2';
//                    } else if (myNodeName == 'PUBLIC' || d['depth'] == 3 || d['depth'] == 4 || d['depth'] == 5 || d['depth'] == 6 || d['depth'] == 7) {
//                        return '#f3cea1'
//                    } else if (myNodeName == 'TDP') {
//                        return '#e3b713';
//                    } else if (myNodeName == 'TRS') {
//                        return '#FE0175';
//                    } else if (myNodeName == 'YSRCP') {
//                        return '#0266b4';
//                    } else if (myNodeName == 'OTHERS') {
//                        return '#f3cea1';
//                    } else {
...
//                    var parentNode = d['parent']['nodeName'];
                    if (d["fillcolor"] != null && d["fillcolor"] != undefined && d["fillcolor"] != '') {
                        return d["fillcolor"];
                    } else {
                        return "#FFFFFF";
                    }
...
//                        return "#FFFFFF";
//                    }
//                    if (d["depth"] == 1 && nodeName == 'News Channel' || nodeName == 'NEWS CHANNEL') {
//                        return "#A6DE87";
//                    } else if (d["depth"] == 1 && (nodeName == 'YOUTUBE' || nodeName == 'Youtube')) {
//                        return "#FF0000";
//                    } else if (d["depth"] == 1 && (nodeName == 'Twitter' || nodeName == 'TWITTER')) {
//                        return "#1DA1F2";
//                    } else if (d["depth"] == 1 && (nodeName == 'NEWS PAPER' || nodeName == 'News Paper')) {
//                        return "#F3CEA1";
//                    }
//                    if (d["depth"] == 2 && parentNode == 'News Channel' || parentNode == 'NEWS CHANNEL'){
//                        return "#A6DE87";
//                    } else if (d["depth"] == 2 && (parentNode == 'YOUTUBE' || parentNode == 'Youtube')){
//                        return "#FF0000";
//                    } else if (d["depth"] == 2 && (parentNode == 'Twitter' || parentNode == 'TWITTER')){
//                        return "#1DA1F2";
//                    } else if (d["depth"] == 2 && (parentNode == 'NEWS PAPER' || parentNode == 'News Paper')){
//                        return "#F3CEA1";
//                    }
//                    else if (d["depth"] == 2 && nodeName == 'TDP') {
//                        return "#E3B713";
//                    } else if (d["depth"] == 2 && (nodeName == 'YCP' || nodeName == 'YSRCP')) {
//                        return "#0266B4";
//                    } else if (d["depth"] == 2 && (nodeName == 'PUBLIC' || nodeName == 'OTHERS')) {
//                        return "#F3CEA1";
//                    } else if (d["depth"] == 2 && (nodeName == 'JSP' || nodeName == 'JANASENA')) {
//                        return "#DA2824";
//                    } else if (d["depth"] == 2 && (nodeName == 'TRS' || nodeName == 'Trs')) {
//                        return "#FE0175";
//
//                    } else if (d["depth"] == 2 && (nodeName == 'BJP' || nodeName == 'Bjp')) {
//                        return "#F97D09";
//                    } else if (d["depth"] == 2 && (nodeName == 'INC' || nodeName == 'Inc')) {
//                        return "#009900";
//
//                    } else if (d["depth"] == 2 && (nodeName == 'IND' || nodeName == 'Ind')) {
//                        return "#DC3066";
//
//                    } else if (d["depth"] == 2 && (nodeName == 'AIMIM' || nodeName == 'Aimim')) {
//                        return "#20783B";
//
//                    } 
//                    else if (d["depth"] == 2 && (nodeName == 'PILOG' || nodeName == 'PiLog')) {
//                        return "#1DA1F2";
//
//                    } 
//                    else if (d["depth"] == 2 && (nodeName == null || nodeName == 'undefined')) {
//                        return "#DA2824";
//                    } else if (d["depth"] == 3 && nodeName == 'TDP') {
//                        return "#E3B713";
//                    } else if (d["depth"] == 3 && nodeName == 'YCP') {
//                        return "#0266B4";
//                    } else if (d["depth"] == 3 && nodeName == 'PUBLIC') {
//                        return "#F3CEA1";
//                    } else if (d["depth"] == 3 && nodeName == 'JSP') {
//                        return "#DA2824";
//                    } else if (d["depth"] == 3 && nodeName == 'TRS') {
//                        return "#FE0175";
//                    } else if (d["depth"] == 3 && nodeName == 'BJP') {
//                        return "#F97D09";
//                    } else if (d["depth"] == 3 && nodeName == 'INC') {
//                        return "#009900";
//                    } else if (d["depth"] == 3 && nodeName == 'IND') {
//                        return "#DC3066";
//                    } 
//                    else if (d["depth"] == 3 && (nodeName == 'AIMIM' || nodeName == 'Aimim')) {
//                        return "#20783B";
//
//                    } 
//                    else if (d["depth"] == 3 && (nodeName == 'PILOG' || nodeName == 'PiLog')) {
//                        return "#1DA1F2";
//
//                    }
//                    else if (d["depth"] == 4 && nodeName == 'TDP') {
//                        return "#E3B713";
//                    } else if (d["depth"] == 4 && nodeName == 'YCP') {
//                        return "#0266B4";
//                    } else if (d["depth"] == 4 && nodeName == 'PUBLIC') {
//                        return "#F3CEA1";
//                    } else if (d["depth"] == 4 && nodeName == 'JSP') {
//                        return "#DA2824";
//                    } else if (d["depth"] == 4 && nodeName == 'TDP') {
//                        return "#E3B713";
//                    } else if (d["depth"] == 4 && nodeName == 'BJP') {
//                        return "#F97D09";
//                    } else if (d["depth"] == 4 && nodeName == 'INC') {
//                        return "#009900";
//                    } else if (d["depth"] == 4 && nodeName == 'IND') {
//                        return "#DC3066";
//                    } 
//                    else if (d["depth"] == 4 && (nodeName == 'AIMIM' || nodeName == 'Aimim')) {
//                        return "#20783B";
//
//                    } 
//                    else if (d["depth"] == 4 && (nodeName == 'PILOG' || nodeName == 'PiLog')) {
//                        return "#1DA1F2";
//
//                    }
//                    if (d["depth"] == 3)
...
//                        return $("#colorAdderlevel4").val();
        ...
        nodeEnter.append('foreignObject')
            ...
            var nodeHtmlStr = '';
            if (d["depth"] == 0) {
                if (d.count != null && d.count != '' && d.count != undefined)
                {
//                    divStr = '<b><img src=' + d.icon + ' width="18px"/></b>' + d.count + '<br>'
                } else {
                    divStr = '';
                }
            } else if (d["depth"] == 3) {
...
//                {
//                    divStr = '<b><img src=' + d.icon + ' width="18px"/></b>' + d.count + '<br>'
//                } else if (d.nodeName.includes("Like")) {
//                    divStr = '<b><img src=' + d.likeIcon + ' width="18px"/></b>';
//                } else if (d.nodeName.includes("Views") || d.nodeName.includes("Retweet")) {
//                    divStr = '<b><img src=' + d.viewsIcon + ' width="15px"/></b>';
//                } else if (d.nodeName.includes("Dislike")) {
//                    divStr = '<b><img src=' + d.disLikeIcon + ' width="18px"/></b>';
//                } else if (d.nodeName.includes("Comments")) {
//                    divStr = '<b><img src=' + d.commentIcon + ' width="18px"/></b>';
//                } else if (d.nodeName.includes("Positive")) {
//                    divStr = '<b><img src=' + d.positiveIcon + ' width="18px"/></b>';
//                } else if (d.nodeName.includes("Negative")) {
//                    divStr = '<b><img src=' + d.negativeIcon + ' width="18px"/></b>';
//                } else if (d.nodeName.includes("Neutral")) {
//                    divStr = '<b><img src=' + d.neutralIcon + ' width="18px"/></b>';
//                } else {
//                    divStr = '';
//                }
            } else {   //som 19-10-2023 
...
//                }
            ...
            try {
                nodeHtmlStrData = d["nodeHtmlStr"];
            } catch (e) {
                nodeHtmlStrData = '';
            }

            nodeHtmlStr = (nodeHtmlStrData != null && nodeHtmlStrData != ''
                    && nodeHtmlStrData != 'undefined' && nodeHtmlStrData != undefined) ? nodeHtmlStrData : '<b>' + d.nodeName + '</b>';
            return '<div style="width: '
                    + (rectNode.width - rectNode.textMargin * 2) + 'px; height: '
                    + (rectNode.height - rectNode.textMargin * 2) + 'px;" class="node-text wordwrap">'
//                    + '<b>' + d.nodeName + '</b><br>'
...
//                    + '<b>Instance: </b>' + d.instance + '<br>'
                ...
                .on('mouseover', function (d) {
                    $('#nodeInfoID' + d.id).css('visibility', 'visible');
                    $('#nodeInfoTextID' + d.id).css('visibility', 'visible');
                    if (d['nodetooltip'] != null && d['nodetooltip'] != ''
                            && d['nodetooltip'] != 'undefined' && d['nodetooltip'] != undefined) {
                        tooltip.transition().duration(200).style("opacity", 0.9);
                        tooltip.html(d['nodetooltip']);
                    }
        ...
        if (imagesrc != null && imagesrc != '' && imagesrc != 'undefined' && imagesrc != undefined) {
            nodeEnter.append('image')
                    .attr('xlink:href', imagesrc)
                    .attr('x', function () {
                        return (imageX != null && imageX != '' && imageX != 'undefined' && imageX != undefined) ? parseInt(imageX)
                                : -25
                    })
                    .attr('y', function () {
                        return (imageY != null && imageY != '' && imageY != 'undefined' && imageY != undefined) ? parseInt(imageY)
                                : -25
                    })
                    .attr('width', function () {
                        return (imagewidth != null && imagewidth != '' && imagewidth != 'undefined' && imagewidth != undefined) ? parseInt(imagewidth)
                                : 50
                    })
                    .attr('height', function () {
                        return (imageHeight != null && imageHeight != '' && imageHeight != 'undefined' && imageHeight != undefined) ? parseInt(imageHeight)
                                : 50
                    });
        }
...
////                })    
    ...
    function getLevelWiseDeTreeData(d) {
        showLoader();
        $.ajax({
            url: 'getDecompositionChilTreeBox',
            type: "POST",
            dataType: 'json',
            traditional: true,
            cache: false,
            async: true,
            data: {
                highLevelFieldVal: d.nodeId,
                treeId: d.deCompTreeId,
                datafilterColName: d.next,
            },
            success: function (response) {
                stopLoader();
                if (response != null && !jQuery.isEmptyObject(response))
                {
                    var result = response.children;
                    var exportBoxTreeJson = {};
                    exportBoxTreeJson['data'] = response;
                    popUpNestedObjToArray(exportBoxTreeJson['data'], true);
                    if (result != null && !jQuery.isEmptyObject(result))
                    {
                        var height = result.length * 42;
                        var svgHeight = $("#dxpDecomposeTreeClass").find("svg").attr("height");
                        if (height > parseInt(svgHeight)) {
                            $("#dxpDecomposeTreeClass").find("svg").attr("height", height + 200);
                        }
                        $(".homeTreeCardDiv").css("overflow-y", "auto");
                        var svgWidth = $("#dxpDecomposeTreeClass").find("svg").attr("width");
                        if (svgWidth != null && svgWidth != '' && svgWidth != undefined)
                        {
                            svgWidth = parseInt(svgWidth) + 200;
                            $("#dxpDecomposeTreeClass").find("svg").attr("width", svgWidth);
                        }
