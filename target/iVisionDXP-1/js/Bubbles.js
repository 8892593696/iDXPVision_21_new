...
function Bubbles(container, self, options) {
    ...
    this.typeInput = function (callbackFn) {
        ...
        inputText.addEventListener("keypress", function (e) {
            ...
            if (e.keyCode == 13) {
                ...
                if (!this.value.trim()) {
                    this.value = "Kindly give a valid message.";
    ...
    this.reply = function (turn) {
        ...
        if (turn.reply !== undefined) {
            ...
            for (var i = 0; i < turn.reply.length; i++) {
                ...
                (function (el, count) {
                    questionsHTML +=
                            '<div class="bubble-button" style="animation-delay: ' +
    ...
    this.answer = function (key, content) {
        ...
        if (_convo[key] !== undefined && content !== undefined) {
            interactionsSave(
                    '<div class="bubble-button reply-pick">' + content + "</div>",
                    "reply reply-pick"
                    )
        }
    }
                    ...
                    for (var i = 0; i < bubbleButtons.length; i++) {
                        ...
                        (function (el) {
                            ...
                            if (el.classList.contains('bubble-pick')) {
                                el.classList.remove("buttonRemove");
                            } else {
                                el.classList.add("buttonRemove");
                            }
