...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {
        ...
        _handleeditkeydown: function (T, j) {
            ...
            if (this.editchar != null && this.editchar != '' && this.editchar != undefined) {
                var clickedcColumns = this._clickedcolumn;
                var totalColumns = this._columns;
                for (var i = 0; i < totalColumns.length; i++) {
                    var datafiledName = totalColumns[i].datafield;
                    if (clickedcColumns != null && clickedcColumns != undefined && clickedcColumns != "" &&
                            datafiledName != null && datafiledName != undefined && datafiledName != "" && clickedcColumns == datafiledName) {
                        var cellsRenderer = totalColumns[i].cellsrenderer;
                        var cellsRendererName = "";
                        if (cellsRenderer != null && cellsRenderer != undefined && cellsRenderer != "") {
                            cellsRendererName = totalColumns[i].cellsrenderer.name;
                            if (cellsRendererName != null && cellsRendererName != undefined && cellsRendererName != "" && cellsRendererName == 'drpdownGridAndEditRender') {
                                this.editcell = true;
                            }
                        }
